<form action="#" method="get" class="product-filter C-6 Mb-l Mb-m Mb-s">
    <div class="P30-b">Фильтр товаров</div>
    <div class="product-filter__flex-container">
        ...
        <div class="product-filter__block">
            ...
            @endforeach
            <a href="#" class="product-filter__all-manufacturer t-underline P14 C-6">Показать все производители</a>
        </div>
        <div class="product-filter__block">
    ...
    <div class="product-filter__button-container">
        <button type="reset" class="btn btn-filter">Очистить фильтр</button>
    </div>
</form>
