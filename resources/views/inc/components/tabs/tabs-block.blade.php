<div class="tabs">
    <div class="tabs__triggers P18-b C-15">
        <div data-tab-name="tab-1" class="tab-trigger js-tab-trigger">{{ $tab1['triggerName'] }}</div>
        ...
        <div data-tab-name="tab-4" class="tab-trigger js-tab-trigger is-active">{{ $tab4['triggerName'] }}</div>
        <div data-tab-name="tab-5" class="tab-trigger js-tab-trigger">{{ $tab5['triggerName'] }}</div>
    </div>
    <div class="tab-content Py-l Py-s tab-1">
    ...
    <div class="tab-content Py-l Py-s tab-4 is-active">
